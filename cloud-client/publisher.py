...
#----------------------- Start Custom Publisher for demo purpose ---------------------
def publish_avro_messages(project_id, topic_name):
    from google.cloud import pubsub_v1
    ...
    datum = [
        {"id": "1", "score": 100, "type": "Mobile", "ts": 6},
        {"id": "1", "score": 100, "type": "Browser", "ts": 6},
        {"id": "1", "score": 150, "type": "Browser", "ts": 8},
        {"id": "2", "score": 200, "type": "Mobile", "ts": 8,},
        {"id": "3", "score": 200, "type": "Browser", "ts": 8},
        {"id": "1", "score": 200, "type": "Request", "ts": 8},
        {"id": "1", "score": 200, "type": "Browser", "ts": 16},
        {"id": "3", "score": 200, "type": "Browser", "ts": 21},
        {"id": "4", "score": 200, "type": "Mobile", "ts": 27},
        {"id": "3", "score": 200, "type": "Browser", "ts": 27},
    ]
    ...
    for i in range(0, limit):
        index = i % len(datum)
        data = datum[index]
        data['gh6'] = random.choice(string.ascii_lowercase)
        ...
        # When you publish a message, the client returns a future.
        future = publisher.publish(topic_path, data=bytes_array)

    print(limit)

# --------------------End Custom Publisher for demo purpose-------------------------
...
if __name__ == "__main__":
    ...
    publish_avro_parser = subparsers.add_parser(
        "publish-avro", help="custom avro publisher"
    )
    publish_avro_parser.add_argument("topic_name")
    ...
    elif args.command == "publish-avro":
            publish_avro_messages(args.project_id, args.topic_name)
